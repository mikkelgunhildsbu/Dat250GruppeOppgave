...
public class FeedAppApplication {
	...
	public CommandLineRunner demo(CustomerRepository repository) {
		return (args) -> {
			...
			repository.save(new Customer("TestUser", "test@test.com", "secret"));
			repository.save(new Customer("TestUser2", "test2@test.com", "secret2"));
			...
			Customer customer = repository.findByUserId(1L);
